...
If (Not:C34(Bool:C1537(Storage:C1525.curl.init)))
	...
	CURL__moduleDebugDateTimeLine(4; Current method name:C684; "curl plugin version : "+$vo_curlVersion.pluginVersion+", curl library version : "+$vo_curlVersion.version+"\r"+JSON Stringify:C1217($vo_curlVersion; *))
	CURL__moduleDebugDateTimeLine(4; Current method name:C684; "curl plugin version (long) : "+CURL_pluginVersionGet(True:C214))
