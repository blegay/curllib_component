//%attributes = {"shared":true,"invisible":false}
  ...
  //@scope : public
  //@deprecated : no
  //@description : This function uses curl plugin to do a http PUT
...
If ($vl_nbParam>4)
	...
	CURL__httpRequestObjPrep ($vo_curlOptions;$vt_url;"PUT";$vp_extraHttpHeaderLinesArrayPtr;$vt_contentType)
