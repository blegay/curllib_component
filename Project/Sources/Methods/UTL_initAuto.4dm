...
C_POINTER:C301($1)  //init var flag
C_TEXT:C284($2)  //compiler method
C_TEXT:C284($3)  //initialization method

C_POINTER:C301($vp_intitVarFlagPtr)  //init var flag
C_TEXT:C284($vt_compilerMethod)  //compiler method
C_TEXT:C284($vt_initMethod)  //initialization method
...
If ($vl_nbParam>1)
	...
	//Declare a local flag to execute the optionnal initialization method
