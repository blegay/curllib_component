//%attributes = {"invisible":true,"preemptive":"capable","shared":false}
  ...
  //@scope : public
  //@deprecated : no
  //@description : This function returns the plateform string (i.e. "MacOS™ version 10.6.8 (Intel)")
...
If (True:C214)
	...
	If (False:C215)
		  //%T-
		SET TEXT TO PASTEBOARD:C523(JSON Stringify:C1217($vo_systemInfos;*))
		  //%T+
	End if 
...
Else 
	  ...
	  //_O_PLATFORM PROPERTIES($vl_platform;$vl_system;$vl_machine;$vl_langue)
	  //Case of 
	  ...
	  //  //$vt_platformOS:="MacOS™ version "+$vt_macOSVers≤1≥+"."+$vt_macOSVers≤2≥
	  //  // $vt_macOSVersRev:=$vt_macOSVers≤3≥
	  ...
	  //  //$vt_platformOS:=$vt_platformOS+"MacOS™ version "
	  //  //<Modif>
	  ...
	  //  //<Modif> Bruno LEGAY (BLE) (20/02/2015)
	  //  ////HTTP__moduleDebugDateTimeLine (2;Nom méthode courante;"unkown os x version (macOSVers : "+$vt_macOSVers+")")
	  //  //<Modif>
	  ...
	  //  //HTTP__moduleDebugDateTimeLine (2;Nom méthode courante;"unknow windows ("+Chaîne($vl_winMajVers)+"."+Chaîne($vl_winMinVers)+") version MajVers : "+Chaîne($vl_winMajVers)+", MinVers : "+Chaîne($vl_winMinVers))
	  //Else 
