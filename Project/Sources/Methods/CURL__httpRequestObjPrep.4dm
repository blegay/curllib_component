...
CURL__optionsObj($vo_curlOptions.request.curlOptions; "FOLLOWLOCATION"; 1; False:C215)
//<Modif>
//CURL__optionsObj ($vo_curlOptions.request.curlOptions;"FOLLOWLOCATION";1;False)
//<Modif>

//If ($vt_url:="https://@")
// we could get a "http://" redirected to "https://" so always assume https
CURL_sslParamsObj($vo_curlOptions.request.curlOptions)
//End if 
...
If ($vo_curlOptions.request.curlOptions.CONNECTTIMEOUT=Null:C1517)
...
If ($vo_curlOptions.request.curlOptions.TIMEOUT=Null:C1517)
