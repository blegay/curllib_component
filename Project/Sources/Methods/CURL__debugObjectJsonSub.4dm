...
$vl_valueType:=Is object:K8:27  // Value type($vo_object)
Case of 
		...
		For ($vl_propertyIndex; 1; $vl_propCount)
			...
			Case of 
				...
				: ($vl_propertyType=Is collection:K8:32)
					...
					//OB SET($vo_object;$vt_propertyName;DBG_passwordDebug ($vt_password))
					
					//  //CURL__debugObjectJsonSub (OB Get($vo_object;$vt_propertyName);$co_passwordProp)
