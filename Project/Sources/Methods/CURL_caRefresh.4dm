...
//@parameter[2-IN-url-TEXT] : pem file url (optional, default : "https://curl.se/ca/cacert.pem")
...
If ($vo_curlOptions.URL=Null:C1517)
	//<Modif> Bruno LEGAY (BLE) (18/03/2021) - v2.00.04
...
//<Modif> Bruno LEGAY (BLE) (02/06/2020) - v2.00.04 
$vo_curlOptions.FOLLOWLOCATION:=1
...
//AJOUTER A TABLEAU($tl_curlKeysCommon;CURLOPT_CAINFO)
//AJOUTER A TABLEAU($tt_curlValuesCommon;"")
...
//  //AJOUTER A TABLEAU($tt_curlValues;"Accept: */*")
...
//AJOUTER A TABLEAU($tl_curlKeys;CURLOPT_CUSTOMREQUEST)
//AJOUTER A TABLEAU($tt_curlValues;"HEAD")

// https://curl.se/libcurl/c/CURLOPT_HEADER.html
//AJOUTER A TABLEAU($tl_curlKeys;CURLOPT_HEADER)
//AJOUTER A TABLEAU($tt_curlValues;"1")

// this array will be set with the CURL_headerCallback function
//ARRAY TEXT(tt_CURL_httpHeaders;0)

$vo_curlOptions.NOBODY:=1  // Just HEAD

C_LONGINT:C283($vl_curlError)

//C_TEXT($vt_curlOptionsJson)
//$vt_curlOptionsJson:=JSON Stringify($vo_curlOptions)
...
$vo_curlResult:=cURL($vo_curlOptions; $vx_curlRequestBody; $vx_curlResponseBody; $vt_callbackMethod)  //; $vt_transferInfo; $vt_headerInfo)
...
// $vo_curlResult.status - longint
// $vo_curlResult.headerInfo - text
// $vo_curlResult.transferInfo - object


//$vl_curlError:=cURL ($vt_url;$tl_curlKeys;$tt_curlValues;$vx_curlRequestBody;$vx_curlResponseBody;$vt_curlInfos)
...
If (($vl_curlError=0) & (Length:C16($vt_headerInfo)>0))
	...
	CURL__moduleDebugDateTimeLine(4; Current method name:C684; "HEAD url : \""+$vo_curlOptions.URL+"\""+\
		...
		", curl options : "+JSON Stringify:C1217($vo_curlOptions)+"\r"+\
		", transfer infos : "+$vt_transferInfo+"\r"+\
	...
	If ($vl_curlError=0)
		...
		Else 
			...
			//$vl_curlError:=cURL($vo_curlOptions; $vx_curlRequestBody; $vx_curlResponseBody; $vt_callbackMethod; $vt_transferInfo; $vt_headerInfo)
